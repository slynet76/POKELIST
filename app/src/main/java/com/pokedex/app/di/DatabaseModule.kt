...
object DatabaseModule {
    ...
    @Provides fun provideAbilityDao(db: AppDatabase): AbilityDao = db.abilityDao()
    @Provides fun provideVariantAbilityDao(db: AppDatabase): VariantAbilityDao = db.variantAbilityDao()
}
